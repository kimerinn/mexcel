...
public class Cell {
	public static enum CELL_TYPE {TEXT_CELL, NUMBER_CELL, EXPRESSION_CELL, ERROR_CELL};
	...
	public String toString() {
		switch (getCellType()) {
			case TEXT_CELL: return getTextVal();
			case EXPRESSION_CELL: return getExpVal();
			case NUMBER_CELL: return String.valueOf(getNumVal());
			case ERROR_CELL: return "#" + getErrVal();//we want to render errors with "#"
