...
public class MicroExcel {
	 ...
	 * Next lines contain cell data. Cells could contain nothing (null),
	 * non-negative number, text or expression (including cell references).
	 * 
	 * expression ::= ’=’ term {operation term}* term ::= cell_reference |
	 * nonnegative_number cell_reference ::= [A-Za-z][0-9] — operation ::= ’+’ | ’-’
	 * | ’*’ | ’/’ text ::= ’\’’ {printable_character}
	 * 
	 * Data delimiter is whitespace.
	 * 
	 * Table data example: 3 4 12 =C2 3 ’Sample =A1+B1*C1/5 =A2*B1 =B3-C3 ’Spread
	 * ’Test =4-3 5 ’Sheet
	 * 
